...
# DEFAULT: normal window. "anti-tracking" profile enables ETP + 3P cookie blocking.
# Redirect/refresh watch; dynamic cookie diffs; popup seen; wildcard targets.
...
def run_one(job: dict, src_workbook: Path, out_workbook: Path):
    opts = Options()
    # Apply any privacy prefs from matrix.yaml
